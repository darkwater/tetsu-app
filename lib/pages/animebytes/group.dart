...
class AnimebytesGroupPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final gProvider = ref.watch(abGroupProvider(id));
    if (!gProvider.hasValue) {
      if (gProvider.hasError) {
        print(gProvider.stackTrace);
        return Scaffold(
          body: Center(
            child: Text(gProvider.error.toString()),
          ),
        );
      }
    ...
    final torrent = group.torrents.first;
        ...
        children: [
          SizedBox(
            ...
            child: AnimeCard(
              ...
              actions: [
                for (final link in group.links.entries)
                  TextButton.icon(
